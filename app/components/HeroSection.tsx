  ...
  return (
    <section className="relative flex min-h-[70vh] flex-col items-center justify-center text-center">
      ...
      <div className="mt-8 flex flex-col gap-4 sm:flex-row">
        ...
        <a
          href="https://github.com/ShunyuYao"
          target="_blank"
          rel="noopener noreferrer"
          className="relative z-10 inline-flex items-center justify-center gap-2 rounded-full border border-[var(--foreground)]/20 px-6 py-3 font-medium transition-opacity hover:opacity-70"
        >
          <svg
            className="h-5 w-5"
            viewBox="0 0 24 24"
